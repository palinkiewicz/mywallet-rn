 ...
 */
export default function ScreenAnimatingOnKeyboard({ children, maxNotchlessStatusBarHeight = 24 }) {
    // Getting app's window height.
    var windowHeight = Dimensions.get('window').height;
    if (StatusBar.currentHeight > maxNotchlessStatusBarHeight) windowHeight += StatusBar.currentHeight;
