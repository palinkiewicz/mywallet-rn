...
export default function SignUpScreen({ navigation }) {
    ...
    const [passwordConfirmationErrorOccured, setpasswordConfirmationErrorOccured] = useState(false);
    const [passwordConfirmationHelperText, setpasswordConfirmationHelperText] = useState('');

    return (
        <View style={[styles.screenWrapper]}>
            <View style={styles.mainView}>
                <Text style={styles.welcomeText} variant='headlineMedium'>Sign up to myWallet</Text>
                <View style={styles.signUpWrapper}>
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => {
                            ...
                            setEnteredPasswordConfirmation(text);
                        }}
                        value={enteredPasswordConfirmation}
                    />
                    <HelperText type='error' visible={passwordConfirmationErrorOccured}>{passwordConfirmationHelperText}</HelperText>
                    <Button style={styles.signUpButton} mode='contained' onPress={() => navigation.navigate('Home')}>Sign up</Button>
                </View>
