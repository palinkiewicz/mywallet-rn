...
import { addCashAccount } from '../components/logic/firestore/accounts/AddCashAccount';
    ...
    return (
        <View style={styles.view}>
            ...
            <TextInputWithError
                ...
                error={errors.icon}
            />
            <ButtonDisabledOnError onPress={onSubmit} mode="contained" style={styles.addButton} errors={errors}>
                Add account
